...
public class HorseResource {
    ...
    @PostMapping("/horses")
    @Timed
    public ResponseEntity<Horse> createHorse(@RequestBody Horse horse) throws URISyntaxException {
    ...
    @PutMapping("/horses")
    @Timed
    public ResponseEntity<Horse> updateHorse(@RequestBody Horse horse) throws URISyntaxException {
