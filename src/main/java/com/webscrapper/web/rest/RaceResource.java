...
public class RaceResource {
    ...
    @GetMapping("/races")
    @Timed
    public List<Race> getAllRaces() throws JSONException {
     ...
     * @throws JSONException 
     */
    @GetMapping("/races/{state}")
    @Timed
    public void findByState(@PathVariable String state) throws JSONException {
        log.debug("REST request to get Race : {}", state);
         raceService.findByState(state);
        return;
    }
